...
def download_txt(url, book, dest_folder, payload):
...
def download_img(url, book, dest_folder):
...
def main():
    ...
    for book_id in book_ids:
        ...
        while True:
            ...
            try:
                if not skip_txt:
                    download_txt(file_url, book, dest_folder, payload)
                if not skip_imgs:
                    download_img(full_img_url, book, dest_folder)
